...
作成日: 2026-05-08  
ステータス: **本番 deploy @13 完了（2026-05-08）**
...
|---|---|
| version | **@13** |
| deploymentId | `AKfycbxODNWJNcCJVQnDXHzzWck237hnUIIXR_Ilt8SS5P5zodfF2dnmKeqso8BL8hcinVEBrQ` |
| exec URL | `https://script.google.com/macros/s/AKfycbxODNWJNcCJVQnDXHzzWck237hnUIIXR_Ilt8SS5P5zodfF2dnmKeqso8BL8hcinVEBrQ/exec` |

## 本番確認結果（@13）

| ページ | nav | active | target | secret |
|---|---|---|---|---|
| home | ✅ | 🏠 HOME | ✅ _top | ✅ |
| search | ✅ | 患者検索 | ✅ _top | ✅ |
| detail | ✅ | 患者検索 | ✅ _top | ✅ |
| monthlyClaims | ✅ | 月次申請 | ✅ _top | ✅ |
| monthlyClaimDetail | ✅ | 月次申請 | ✅ _top | ✅ |
| selfpay | ✅ | 自費明細 | ✅ _top | ✅ |
